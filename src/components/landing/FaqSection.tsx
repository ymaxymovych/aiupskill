...
const FAQ_ITEMS = [
  {
    ...
    a: "10 годин за 5 днів. Можна розбити на 2 години щодня.",
  },
  {
  ...
  },
  {
    ...
    a: "50 людей × 1 999 грн = 99 950 грн. Доступ на 12 місяців. Перший модуль — безкоштовно. Точну ціну для вашої команди порахує бігунок у секції Ціни.",
  },
  {
    q: "А звідки цифра 5x?",
    a: "Дослідження Anthropic на 100 000 реальних задачах. Також підтверджується: PwC (66% приріст, 308 компаній), Stanford (2.5x, 18 задач), IBM (4.5 млрд приріст, 270 000 працівників).",
  },
  {
