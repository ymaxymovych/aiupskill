...
const MODULES = [
  ...
  { num: "02", title: "AI-інструменти та агенти", desc: "Claude, ChatGPT, n8n, vibe-coding, API-інтеграції" },
  { num: "03", title: "Побудова AI-ланцюжка", desc: "Від ТЗ до працюючої автоматизації. Перша автоматизація — вже в перший день" },
  { num: "04", title: "Запуск і вимірювання", desc: "Деплой, аналітика, ROI — реальні результати для бізнесу" },
  { num: "05", title: "Фінальний проект", desc: "Здача повноцінної автоматизації, яка працює 24/7" },
];
